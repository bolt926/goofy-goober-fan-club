document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        ...
        squares[i].onclick = function(){
            //if the square below the square your clicking on is taken you can take it
            if(squares[index + 7].classList.contains('taken')){
                ...
                //if square below where you're clicking is taken, you recieve an alert
            }else alert('Sorry, you cant go here')
        }
    })(i)
    ...
    //now take the four values in each winning array
    ...
    // eventListener that triggers the Checkboard function on click
